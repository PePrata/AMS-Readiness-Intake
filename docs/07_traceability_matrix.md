...
| OBJ-01    | CSF-01 | REQ-010     | —        | —          | AC-1                | — (manual review only) | Assessment, Answer, Evidence, UserRole, ReadinessQuestion, AuditLog | — |
| OBJ-02    | CSF-02 | REQ-011     | UC-007   | US-006     | AC-1, AC-2          | TC-010 / Scenario: Audit entry recorded when evidence is added (audit_trail.feature) | AuditLog (references Assessment, Answer, Evidence) | AT-TBD |
| OBJ-02    | CSF-02 | REQ-012     | UC-007   | US-006     | AC-1, AC-2          | TC-011 / Scenario: Audit log entries cannot be edited or deleted, Audit log does not record unrelated system events (audit_trail.feature) | AuditLog | AT-TBD |
...
- Automated Test: AT-TBD (planned as the role/security automated test in Deliverable 12).
- Explanation:
